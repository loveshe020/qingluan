      ...
      <div className="container-shell">
        <div className="grid gap-8 lg:grid-cols-[1.3fr_0.9fr]">
          <div className="panel-surface grain rounded-[2.4rem] px-6 py-10 md:px-10 md:py-14">
            <p className="text-sm uppercase tracking-[0.32em] text-teal/70">
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-ink/78 md:text-xl">
              Private online consultations in Bazi, Qimen Dunjia, and Feng Shui for those seeking
              clarity, alignment, and a more thoughtful way to navigate life.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[2.4rem] border border-line bg-teal p-8 text-ivory shadow-panel">
            ...
            <div className="relative">
              <p className="text-sm uppercase tracking-[0.28em] text-ivory/70">Approach</p>
              <div className="mt-6 space-y-5">
                <div>
                  <p className="text-xs uppercase tracking-[0.2em] text-jade">Bazi</p>
                  <p className="mt-2 text-lg leading-7 text-ivory/88">
                    A Chinese birth chart system used for self-understanding and life direction.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-2 text-lg leading-7 text-ivory/88">
                    A classical framework for timing, strategic reflection, and situational insight.
                  </p>
                </div>
                <div className="ornament-line opacity-50" />
                <div>
                  ...
                  <p className="mt-2 text-lg leading-7 text-ivory/88">
                    Environmental guidance for flow, balance, and spatial harmony in modern life.
                  </p>
                </div>
              </div>
            </div>
